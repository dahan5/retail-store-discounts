package feqra.retail.store.controller;

import feqra.retail.store.api.rest.controller.CustomerRestController;
...
public class CustomerControllerTest
{
    ...
    public void setUp() {
        ...
        c1.setFirstName("Taleb");
        CustomerDTO c2 = new CustomerDTO();
        c1.setFirstName("Omar");
        CustomerDTO c3 = new CustomerDTO();
        c1.setFirstName("Karim");
